...
class GameManager
{
    BaseAddress := g_idle.getModuleBaseAddress("mono-2.0-bdwgc.dll")+0x003A0574
    __new()
    {
        ;=========================================
...
class GameSettings
{
    BaseAddress := g_idle.getModuleBaseAddress("mono-2.0-bdwgc.dll")+0x003A1C54
    mainOffset := 0xD20
    __new()
    {
            this.GameSettings := new GameObjectStructure([0xA8])
            this.GameSettings.BaseAddress := this.BaseAddress
            this.GameSettings.UserID := new GameObjectStructure(this.GameSettings,,[this.mainOffset + 0x20])
            this.GameSettings.Hash := new GameObjectStructure(this.GameSettings,"UTF-16",[this.mainOffset + 0x28, 0xC])
            this.GameSettings.Platform := new GameObjectStructure(this.GameSettings,,[this.mainOffset + 0x30])
            this.GameSettings.Version := new GameObjectStructure(this.GameSettings,,[this.mainOffset + 0x38]) ; Push MobileClientVersion
            this.GameSettings.PostFix := new GameObjectStructure(this.GameSettings,"UTF-16",[this.mainOffset + 0x3C, 0xC])
            this.GameSettings.GameSettingsInstanceLocation := new GameObjectStructure(this.GameSettings,,[this.mainOffset, 0x0])
